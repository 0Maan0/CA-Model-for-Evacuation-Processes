...
ffca = FFCA(number_rows, number_cols, number_agents, spawn_rate=0.025,
...
for Ntot in number_agents_list:
    ffca = FFCA(number_rows, number_cols, Ntot, spawn_rate=0.025,
                 conflict_resolution_rate=0, alpha=0.3, delta=0.3,
                 static_field_strength=2.5, dynamic_field_strength=5,
                 horizontal_bias=50)  
...
# All densities test
densities = np.linspace(0.1, 0.9, 100)
phi_values = []
